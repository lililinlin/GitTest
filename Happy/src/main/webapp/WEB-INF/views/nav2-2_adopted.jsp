...
<body>
    ...
    <main>
        <div class="wrapper">
            <div class="left"><br>
                <div>
                    <h3 style="text-align: center;">입양됐어요</h3>
                </div>
                <div class="site_int">
                    <br>
                    <h5><a href="nav2-1_adopt.html">입양하기</a></h5><br>
                    <h5><a href="nav2-2_adopted.html">입양됐어요</a></h5><br>
                    <h5><a href="nav2-3_map.html">입양후기</a></h5>
                </div>
                <br><br>
