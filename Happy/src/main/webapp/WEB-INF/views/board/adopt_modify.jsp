     		...
     		<div id="main_wrapper">
				...
				<div class="right">
					<div id = "site">
						...
						<form action="adopt_ModifyAction" method="post">
							
							<table id="main_table">
								<tr>
									<td class="td_title">제목 &nbsp;</td>
								<%-- <td><input type="text" id="title" name="title" ><%=content_view.getQbTitle() %></td> --%>
								<input type="hidden" id="qbidx" name="aidx" value="<%=content_view.getAbIdx() %>">
								<td><textarea id="qbTitle" name="title" ><%=content_view.getAbTitle() %></textarea></td>
								</tr>
								<tr>
									<td class="td_title">작성자 </td>
									<td class="name"><%=content_view.getAbName() %><input type="hidden" id="name" name="name" value="<%=content_view.getAbName() %>"></td>
								</tr>
								<tr>
									<td class="td_title">내용</td>
									<td> 
										<textarea id="editor4" name="editor4"><%=content_view.getAbContent() %></textarea>
										<script>
							...
							<div id = "footer_button">
								...
								<input type="button"  value = "돌아가기" onclick="location.href='nav2-1_adopt'"/>
							</div>
